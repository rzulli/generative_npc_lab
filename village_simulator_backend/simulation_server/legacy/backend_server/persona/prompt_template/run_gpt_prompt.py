...
from ..prompt_template.print_prompt import *
...
def run_gpt_prompt_wake_up_hour(persona, test_input=None, verbose=False): 
  ...
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/wake_up_hour_v1.txt"
...
def run_gpt_prompt_daily_plan(persona, 
  ...
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/daily_planning_v6.txt"
...
def run_gpt_prompt_generate_hourly_schedule(persona, 
  ...
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/generate_hourly_schedule_v2.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 50, 
               ...
               "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/generate_hourly_schedule_v2.txt"
  prompt_input = create_prompt_input(persona, 
                                     curr_hour_str, 
                                     p_f_ds_hourly_org,
                                     hour_str, 
...
def run_gpt_prompt_task_decomp(persona, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 1000, 
             "temperature": 0, "top_p": 1, "stream": False,
             "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/task_decomp_v3.txt"
...
def run_gpt_prompt_action_sector(action_description, 
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/action_location_sector_v2.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v1/action_location_sector_v1.txt"
  prompt_input = create_prompt_input(action_description, persona, maze)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_action_arena(action_description, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v1/action_location_object_vMar11.txt"
...
def run_gpt_prompt_action_game_object(action_description, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v1/action_object_v2.txt"
...
def run_gpt_prompt_pronunciatio(action_description, persona, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/generate_pronunciatio_v1.txt" ########
  prompt_input = create_prompt_input(action_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "🛁🧖‍♀️" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/generate_pronunciatio_v1.txt"
  # prompt_input = create_prompt_input(action_description)
...
def run_gpt_prompt_event_triple(action_description, persona, verbose=False): 
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/generate_event_triple_v1.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 30, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/generate_event_triple_v1.txt"
  prompt_input = create_prompt_input(action_description, persona)
  prompt = generate_prompt(prompt_input, prompt_template)
  fail_safe = get_fail_safe(persona) ########
  output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_act_obj_desc(act_game_object, act_desp, persona, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/generate_obj_event_v1.txt" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": ["\n"]}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/generate_obj_event_v1.txt"
  # prompt_input = create_prompt_input(act_game_object, act_desp, persona)
  # prompt = generate_prompt(prompt_input, prompt_template)
  # fail_safe = get_fail_safe(act_game_object)
  # output = safe_generate_response(prompt, gpt_param, 5, fail_safe,
...
def run_gpt_prompt_new_decomp_schedule(persona, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 1000, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/new_decomp_schedule_v1.txt"
  prompt_input = create_prompt_input(persona, 
                                     main_act_dur, 
                                     truncated_act_dur, 
                                     start_time_hour,
...
def run_gpt_prompt_decide_to_talk(persona, target_persona, retrieved,test_input=None, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 20, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/decide_to_talk_v2.txt"
...
def run_gpt_prompt_decide_to_react(persona, target_persona, retrieved,test_input=None, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 20, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/decide_to_react_v1.txt"
  prompt_input = create_prompt_input(persona, target_persona, retrieved,
                                     test_input)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_create_conversation(persona, target_persona, curr_loc,
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 1000, 
               ...
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/create_conversation_v2.txt"
...
def run_gpt_prompt_summarize_conversation(persona, conversation, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/summarize_conversation_v1.txt" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/summarize_conversation_v1.txt"
  # prompt_input = create_prompt_input(conversation, test_input)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_extract_keywords(persona, description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/get_keywords_v1.txt"
...
def run_gpt_prompt_keyword_to_thoughts(persona, keyword, concept_summary, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 40, 
               "temperature": 0.7, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/keyword_to_thoughts_v1.txt"
...
def run_gpt_prompt_convo_to_thoughts(persona, 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 40, 
               "temperature": 0.7, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/convo_to_thoughts_v1.txt"
...
def run_gpt_prompt_event_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/poignancy_event_v1.txt" ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/poignancy_event_v1.txt"
  # prompt_input = create_prompt_input(persona, event_description)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_thought_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/poignancy_thought_v1.txt" ########
  prompt_input = create_prompt_input(persona, event_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "5" ########
  special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/poignancy_thought_v1.txt"
  # prompt_input = create_prompt_input(persona, event_description)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_chat_poignancy(persona, event_description, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/poignancy_chat_v1.txt" ########
  prompt_input = create_prompt_input(persona, event_description)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  example_output = "5" ########
  special_instruction = "The output should ONLY contain ONE integer value on the scale of 1 to 10." ########
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/poignancy_chat_v1.txt"
  # prompt_input = create_prompt_input(persona, event_description)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_focal_pt(persona, statements, n, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/generate_focal_pt_v1.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 150, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/generate_focal_pt_v1.txt"
  prompt_input = create_prompt_input(persona, statements, n)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_insight_and_guidance(persona, statements, n, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 150, 
               "temperature": 0.5, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/insight_and_evidence_v1.txt"
  prompt_input = create_prompt_input(persona, statements, n)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat_summarize_ideas(persona, target_persona, statements, curr_context, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/summarize_chat_ideas_v1.txt" ########
  ...
  #              "temperature": 0.5, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/summarize_chat_ideas_v1.txt"
  # prompt_input = create_prompt_input(persona, target_persona, statements, curr_context)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat_summarize_relationship(persona, target_persona, statements, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/summarize_chat_relationship_v2.txt" ########
  ...
  #              "temperature": 0.5, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/summarize_chat_relationship_v1.txt"
  # prompt_input = create_prompt_input(persona, target_persona, statements)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_agent_chat(maze, persona, target_persona,
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/agent_chat_v1.txt" ########
  ...
  #              "temperature": 0.7, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/agent_chat_v1.txt"
  # prompt_input = create_prompt_input(persona, target_persona, curr_context, init_summ_idea, target_summ_idea)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_summarize_ideas(persona, statements, question, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/summarize_ideas_v1.txt" ########
  ...
  #              "temperature": 0.5, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/summarize_ideas_v1.txt"
  # prompt_input = create_prompt_input(persona, statements, question)
  # prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_generate_next_convo_line(persona, interlocutor_desc, prev_convo, retrieved_summary, test_input=None, verbose=False): 
  ...
  #              "temperature": 0, "top_p": 1, "stream": False,
  #              "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  # prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/generate_next_convo_line_v1.txt" ########
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 250, 
               "temperature": 1, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/generate_next_convo_line_v1.txt"
  prompt_input = create_prompt_input(persona, interlocutor_desc, prev_convo, retrieved_summary)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_prompt_generate_whisper_inner_thought(persona, whisper, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/whisper_inner_thought_v1.txt"
...
def run_gpt_prompt_planning_thought_on_convo(persona, all_utt, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/planning_thought_on_convo_v1.txt"
...
def run_gpt_prompt_memo_on_convo(persona, all_utt, test_input=None, verbose=False): 
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 15, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/memo_on_convo_v1.txt" ########
  prompt_input = create_prompt_input(persona, all_utt)  ########
  prompt = generate_prompt(prompt_input, prompt_template)
  ...
  gpt_param = {"engine": "gpt-3.5-turbo-instruct", "max_tokens": 50, 
               "temperature": 0, "top_p": 1, "stream": False,
               "frequency_penalty": 0, "presence_penalty": 0, "stop": None}
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v2/memo_on_convo_v1.txt"
  prompt_input = create_prompt_input(persona, all_utt)
  prompt = generate_prompt(prompt_input, prompt_template)
...
def run_gpt_generate_safety_score(persona, comment, test_input=None, verbose=False): 
  ...
  print ("11")
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/safety/anthromorphosization_v1.txt" 
...
def run_gpt_generate_iterative_chat_utt(maze, init_persona, target_persona, retrieved, curr_context, curr_chat, test_input=None, verbose=False): 
  ...
  print ("11")
  prompt_template = TEMPLATE_PATH +"persona/prompt_template/v3_ChatGPT/iterative_convo_v1.txt" 
