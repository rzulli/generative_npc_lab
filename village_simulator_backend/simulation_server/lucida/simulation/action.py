...
class ExampleAction(Action):
    ...
    def execute(logger, state, orchestrator):
        ...
        logger.log(f"ExampleAction value {current_value}")
        state.set_data('value', current_value + 1 if current_value else 1)
...
class ExampleAction2(Action):
    ...
    def execute(logger, state, orchestrator):
        ...
        state.set_data('value', current_value + 2 if current_value else 2)
